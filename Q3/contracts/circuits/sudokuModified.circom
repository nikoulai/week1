...
template sudoku() {
    ...
    component rangeProofsSu[82];
    component rangeProofsSol[82];
    
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            var counter = i*9 + j;
            rangeProofsSu[counter] = RangeProof(32);
            rangeProofsSu[counter].in <== puzzle[i][j];
            rangeProofsSu[counter].range[0] <== 0;
            rangeProofsSu[counter].range[1] <== 9;
            rangeProofsSu[counter].out === 1;
            
            rangeProofsSol[counter] = RangeProof(32);
            rangeProofsSol[counter].in <== solution[i][j];
            rangeProofsSol[counter].range[0] <== 0;
            rangeProofsSol[counter].range[1] <== 9;
            rangeProofsSol[counter].out === 1;
